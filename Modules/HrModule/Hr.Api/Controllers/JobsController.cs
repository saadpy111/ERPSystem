...
namespace Hr.Api.Controllers
{
    ...
    public class JobsController : ControllerBase
    {
        ...
        [HttpPost]
        [HasPermission( HrPermissions.JobsCreate)]
        ...
        [HttpGet]
        [HasPermission( HrPermissions.JobsView)]
        ...
        [HttpPut("{id}")]
        [HasPermission( HrPermissions.JobsEdit)]
        ...
        [HttpDelete("{id}")]
        [HasPermission( HrPermissions.JobsDelete)]
        ...
        [HasPermission( HrPermissions.JobsActivate)]
        ...
        [HasPermission( HrPermissions.JobsDeactivate)]
