...
{
    public class CreateSalaryStructureComponentValidator : AbstractValidator<CreateSalaryStructureComponentRequest>
    {
        public CreateSalaryStructureComponentValidator()
        {
