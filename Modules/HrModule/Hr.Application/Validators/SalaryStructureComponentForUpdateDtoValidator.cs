...
{
    public class SalaryStructureComponentForUpdateDtoValidator : AbstractValidator<SalaryStructureComponentForUpdateDto>
    {
        public SalaryStructureComponentForUpdateDtoValidator()
        {
            RuleFor(x => x.Id)
