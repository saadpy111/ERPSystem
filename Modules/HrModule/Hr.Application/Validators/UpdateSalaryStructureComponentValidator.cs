...
{
    public class UpdateSalaryStructureComponentValidator : AbstractValidator<UpdateSalaryStructureComponentRequest>
    {
        public UpdateSalaryStructureComponentValidator()
        {
            RuleFor(x => x.Id)
