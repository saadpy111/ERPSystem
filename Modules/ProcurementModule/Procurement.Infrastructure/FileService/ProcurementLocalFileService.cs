...
namespace Procurement.Infrastructure.FileService
{
    public class ProcurementLocalFileService : IProcurementFileService
    {
        private readonly string _rootPath;

        public ProcurementLocalFileService(string rootPath)
        {
            _rootPath = rootPath;
        }
