...
namespace Website.Application.Features.TenantWebsite.Commands.UpdateConfig
{
    ...
    ///
    /// Sections use List&lt;SectionDto&gt; which supports:
    ///   - File uploads per section (BackgroundImageFile)
    ///   - MERGE semantics: only supplied sections/fields are updated
    /// </summary>
    public class UpdateTenantWebsiteConfigCommand : IRequest<UpdateTenantWebsiteConfigResponse>
    {
        ...
        // ── Sections (MERGE semantics — only supplied sections/fields updated) ────
